...
let GeneratorProto = {
	...
	emit_include_validation_function: function(propertyName, valueSpec)
	{
		...
		this.print(indent, '		let module = require(\'schema' + moduleName + '\');');
	...
	generate: function()
	{
		...
		this.output = fs.open('generated/schemareader.uc', 'w');
	...
	module: function(module)
	{
		...
		this.output = fs.open('generated/' + to_method_name('schema', module) + '.uc', 'w');
...
let generator = instantiateGenerator('./urender.schema.pretty.json');
generator.generate();
